...
2. Corrobora desde la vista de instancia:
   ...
   ```
   SELECT instance_name, instance_role, database_type FROM v$instance;
   ```
...
SHOW PARAMETER shared_pool_size; 
SHOW PARAMETER db_cache_size; 
SELECT component, current_size FROM v$sga_dynamic_components WHERE current_size>0 ORDER BY component; 
SPOOL OFF;
```
<br/><br/>
